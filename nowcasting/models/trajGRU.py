...
class TrajGRU(BaseConvRNN):
    ...
    def __init__(self, input_channel, num_filter, b_h_w, zoneout=0.0, L=5,
        ...
        self.i2h = nn.Conv2d(in_channels=input_channel,
                            ...
                            dilation=self._i2h_dilate) ### This _i2h_dilate I cant find to be initiated anywhere, but it uses (1,1), this was found by simply printing it
    ...
    def forward(self, inputs=None, states=None, seq_len=cfg.HKO.BENCHMARK.IN_LEN):
        if states is None:
            # MH: 2020-05-22 veranderd van torch.float naar torch.float64
